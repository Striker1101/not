...
async function startServer() {
  try {
    ...
    // Step 4: Sync tables
    // Note: disabled alter: true to prevent MySQL "Too many keys specified; max 64 keys allowed" error on frequent restarts.
...
startServer(); // restart to recreate database v3
