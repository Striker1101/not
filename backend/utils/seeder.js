...
async function seedDatabase() {
  try {
    ...
    if (userCount === 0) {
      ...
      // Seed NFT Files
      await NftFile.bulkCreate([
        {
          nft_id: nfts[0].id,
          file_url: "http://localhost:5000/uploads/abstract_waves.png",
        },
        {
          nft_id: nfts[1].id,
          file_url: "http://localhost:5000/uploads/cyber_punk_city.png",
        },
        {
          nft_id: nfts[2].id,
          file_url: "http://localhost:5000/uploads/pixel_kittens.png",
        },
      ]);
      console.log("✅ NFT Files seeded");
